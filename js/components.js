...
(function () {
  ...
  function renderNavbar(rootPath) {
    ...
    el.innerHTML = [
      ...
      '        <a href="' + rootPath + 'SummerClasses.html" class="block px-3 py-2 text-base font-medium text-stone-700 hover:text-[#C2410C] hover:bg-[#FFF7ED] rounded-md">Summer Classes</a>',
  ...
  function renderFooter(rootPath) {
    ...
    el.innerHTML = [
      ...
      '        <ul class="space-y-3">',
      '          <li><a href="' + rootPath + 'programs.html" class="hover:text-[#FB923C] transition-colors text-sm">Hindi Bhasha Program</a></li>',
      ...
      '            <a href="mailto:HindiLanguagePro@gmail.com" class="text-sm hover:text-[#FB923C] transition-colors">HindiLanguagePro@gmail.com</a>',
      '          </li>',
      '        </ul>',
      '      </div>',
