...
import { GraduationCap, Languages, Users, BookOpen, MessageCircle, Baby } from 'lucide-react';
...
export default function Programs() {
  const programs = [
    ...
    {
      title: "Early Years Immersion",
      description: "Play-based language immersion for toddlers and preschoolers to build early bilingual skills.",
      icon: Baby,
      color: "bg-pink-50 text-pink-600",
      features: ["Ages 3-6", "Interactive Play", "Phonetic Basics"]
    },
    {
    ...
    <div className="w-full">
      ...
      <div className="bg-slate-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Comprehensive language and cultural education for every stage of life.
          </motion.p>
        </div>
      </div>
